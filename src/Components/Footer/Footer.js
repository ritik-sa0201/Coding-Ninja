  ...
  return (
    <footer className="dark:bg-opacity-60 backdrop-blur-lg backdrop-filter bg-black  w-screen">
      <div className="flex items-center justify-center flex-col gap-5 py-8 px-5 ">
        ...
        <div className="block md:hidden">
          <div classNameName="md:flex md:items-center md:justify-center">
            <div className="text-white w-fit mx-auto mb-5 mt-7">Follow Us</div>
          </div>
        ...
        >
          ...
          <div className="hidden md:flex md:items-center md:justify-center">
            <span className="text-white w-fit mx-auto mb-5 mt-7">Follow Us</span>
          </div>
      ...
      <div classNameName="dark:bg-neutral-800 dark:bg-opacity-30">
        <div className="mt-7 text-center pt-4 pb-4 text-sm text-white dark:text-stone-200 sm:text-center text-light">
          © 2023 <a href="/">Coding Ninjas IIIT BBSR™</a>. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
